...
struct ProjectTerminalMainView: View {
    ...
    @ObservedObject var store: TerminalSurfaceStore
    ...
    init(
        ...
        workspaceSelection: WorkspaceSelection? = nil,
        ...
        self.store = store
        self.workspaceSelection = workspaceSelection ?? store.projects.selection
    ...
    private var terminalBody: some View {
        Group {
            if let controller = store.projectTerminalController(for: workspaceSelection) {
                AgentTerminalHostView(
                    controller: controller,
                    terminalTheme: store.terminalTheme,
                    terminalBackgroundColor: terminalBackgroundColor,
                    isActive: isSurfaceSelected && store.terminalSurfacesAreForeground,
            ...
            } else if store.projects.path(for: workspaceSelection) == nil {
                SurfaceStateView(
                    icon: "terminal",
