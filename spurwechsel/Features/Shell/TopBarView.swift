...
struct TopBarView: View {
    ...
    private var availablePreviewModels: [PreviewContentModel] {
        previewModels.filter { !$0.id.conflicts(with: layout.selectedMainView) }
    }
                    ...
                    HStack(spacing: SpurSpacing.sm) {
                        ...
                        ForEach(MainViewKind.allCases, id: \.self) { view in
                            ChromeIconButton(
                                ...
                                title: view.title,
                                theme: theme,
                                isSelected: layout.selectedMainView == view,
                    ...
                    HStack(spacing: SpurSpacing.sm) {
                        if !availablePreviewModels.isEmpty {
                            if layout.previewEnabled {
                                ForEach(availablePreviewModels) { model in
                                    ChromeIconButton(
                                        ...
                                        title: model.title,
                                        theme: theme,
                                        isSelected: layout.selectedPreviewView == model.id,
                            ...
                            ChromeIconButton(
                                ...
                                theme: theme,
                                isSelected: layout.previewEnabled,
